 ...
 *advanced facilities like TextPad **********************************/
 ...
 public class Kpad extends JFrame
 {
  ...
  /*********************************************************************/
    ...
    JSplitPane splitPane; // a split window to add textBox and fileList.
 ...
 /*************************************************************************/
  ...
  public Kpad()  // The Constructor.
  {
	...
	File currentDir = new File(System.getProperty("user.dir")); /*to obtain the current working dire*/
		try
		{
...
try
  ...
  /**********************************************************************/
	 ...
	 //final JFileChooser fc = new JFileChooser();
	       Filter filter = new Filter(); ////////To provide a filter to open and save a file using the FileChooser
	...
	newMenuItem.addActionListener(new ActionListener()
          {
			  public void actionPerformed(ActionEvent e)
			  {
				  textBox.setText(null); //this clears anything written on the text box....
				  clip.play();
			  }
		  }
		  );
		 ...
		 public void actionPerformed(ActionEvent e)
		{
		 ...
		 if (returnVal == JFileChooser.APPROVE_OPTION)
		  {
		   ...
		   statusBar.setText(currentFileName); //adds the filename to be opened to the status bar
		  FileReader reader = null; //read the stream of character from the file chosen 
		  try
		  {
          ...
          saveMenuItem.addActionListener(new ActionListener()
		            {
		                public void actionPerformed(ActionEvent e)
		                {
		   					...
		   					if(returnVal == JFileChooser.APPROVE_OPTION)
		   					{
		   					   ...
		   					   FileWriter  writer = null; // unlike fileReader this writes files to a character file
		   					     try
		   					     {
         ...
         openDecodedMenuItem.addActionListener(new ActionListener()
         {
			 public void actionPerformed(ActionEvent ev)
			 {
				 ...
				 if(code.equals("aditya")||code.equals("akshay")||code.equals("anirudh") || code.equals("ujjwal"))
				 {
				 int returnVal = fc.showOpenDialog(Kpad.this);
				 	if (returnVal == JFileChooser.APPROVE_OPTION)
				 	 {
	 ...
	 helpMenuItem.addActionListener(new ActionListener()
	     {
	 		...
	 		public void actionPerformed(ActionEvent e)
		    {
				JOptionPane.showMessageDialog(null,"This is a simple text editor made using javax.swing package Hope You like it....",
...
/**********************************************************************************/
   ...
   Dimension minimumSize = new Dimension(4, 100);
...
this.pack();
 ...
 private void doCeaserAnalysis() 
 {
	 ...
	 currThread.setPriority(Thread.MAX_PRIORITY);//speeds up the the decoding 
...
public static void main(String args[])
{
	UIManager myUIMgr = new UIManager();
		        ...
		        try
		        {
		            UIManager.setLookAndFeel(installedLnFs[option].getClassName());
		        }
		        catch(Exception e)
		        {
	            e.printStackTrace();
